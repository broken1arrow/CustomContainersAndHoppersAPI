...
public interface PreferenceSettingsRegisteryApi {
	...
	static PreferenceSettingsRegisteryApi getInstance() {
		return null;
	}

	Map<UUID, PreferenceSettingsData> getsettingsdata();

	/**
	 * Add player to cache.
	 *
	 * @param playerUUID    player you want to add.
	 * @param settingsData  data player has
	 * @param forceloadData if you want to override old data in cache (old data will be lost).
	 */

	void setPlayerData(UUID playerUUID, PreferenceSettingsData settingsData, boolean forceloadData);
