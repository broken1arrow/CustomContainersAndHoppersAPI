...
public interface ContainerSettingsApi {
    ...
    /**
     * Get the mode how the items inside the container shall be dropped.
     *
     * @return Returns the mode to use and if sett below zero it will default to 1
     */
    ...
    /**
     * Get the specific menu for this container.
     *
     * @return Returns the file name it shall use for the menu.
     */
    String getLinkMenu();

    /**
     * Get the specific filter menu for this container.
     *
     * @return Returns the file name it shall use for the menu.
     */
