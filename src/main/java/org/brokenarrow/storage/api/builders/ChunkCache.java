...
public interface ChunkCache {
     ...
     */
    void setChunkLoadContainerTask(@Nonnull final Location location, @Nonnull final Consumer<ChunkEntry> callback);
     ...
     */
    Map<ChunkKey, ChunkEntry> getTrackedChunks();
     ...
     */
    @Nullable
    ChunkEntry getTrackedChunks(@Nonnull final Location location);
     ...
     */
    @Nonnull
    PlayerChunkTracker getPlayerChunkTracker();
}
