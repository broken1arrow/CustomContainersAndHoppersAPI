...
public abstract class CommandWarper implements CommandHandler {
	 ...
	 */
	public CommandWarper(final String commandLable) {
	 ...
	 * @throws CommandException when an unhandled exception occurs during the execution of a Command.
	 */
